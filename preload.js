...
contextBridge.exposeInMainWorld('petAPI', {
  ...
  onImageScales: (cb) => ipcRenderer.on('image-scales', cb),
  setDisplayImageScale: (factor) => ipcRenderer.send('set-display-image-scale', factor),
  onMouseSpeed: (cb) => ipcRenderer.on('mouse-speed', cb),
  onSpinFollow: (cb) => ipcRenderer.on('spin-follow', cb),
  getSpinMul: () => ipcRenderer.invoke('get-spin-mul'),
  onSpinMul: (cb) => ipcRenderer.on('spin-mul', cb),
  ...
  toggleSpinFollow: () => ipcRenderer.invoke('toggle-spin-follow'),
...
contextBridge.exposeInMainWorld('managerAPI', {
  ...
  getSpinFollow: () => ipcRenderer.invoke('get-spin-follow'),
  setSpinFollow: (on) => ipcRenderer.invoke('set-spin-follow', on),
  getSpinMul: () => ipcRenderer.invoke('get-spin-mul'),
  setSpinMul: (v) => ipcRenderer.invoke('set-spin-mul', v),
  ...
  setImageScale: (payload) => ipcRenderer.invoke('set-image-scale', payload),
